...
exports.Transaction = exports.getScriptByAddress = exports.generateHashLockScript = exports.generateTimeLockScript = exports.generateDataScript = exports.generateKeyPair = exports.generateScriptAddress = exports.generateMultiSigScript = exports.generateSingleSigScript = exports.generateAddress = void 0;
...
const generateSingleSigScript = async (pubkey) => {
    if (pubkey.length !== 66)
        throw new Error('pubkey must be compressed 33 bytes');
    return (Opcode_js_1.default.OP_DUP +
        Opcode_js_1.default.OP_HASH160 +
        '14' + // anything smaller than 4c is byte length to read
        (0, utils_1.bytesToHex)((0, ripemd160_1.ripemd160)((0, sha256_1.sha256)((0, utils_1.hexToBytes)(pubkey)))) +
...
const generateTimeLockScript = async (block, utc, isAbsolute = true) => {
    ...
    const opcode = isAbsolute
        ? Opcode_js_1.default.OP_CHECKLOCKTIMEVERIFY
        : Opcode_js_1.default.OP_CHECKSEQUENCEVERIFY;
    return ((await _readBytesN(locktime)) +
        (await _bigToLitleEndian(locktime)) +
        opcode +
        Opcode_js_1.default.OP_DROP);
};
...
const generateHashLockScript = async (secretHex) => {
    ...
    return (Opcode_js_1.default.OP_HASH256 +
        '20' +
        (0, utils_1.bytesToHex)((0, sha256_1.sha256)((0, sha256_1.sha256)((0, utils_1.hexToBytes)(secretHex)))) +
        Opcode_js_1.default.OP_EQUAL);
};
exports.generateHashLockScript = generateHashLockScript;
const getScriptByAddress = async (address, withLength = false) => {
...
class Transaction {
    ...
    unlockHashInput = async (secretHex, index, timeLockScript = '') => {
        ...
        const redeemScript = timeLockScript + (await (0, exports.generateHashLockScript)(secretHex));
    ...
    getId = async () => {
        ...
        return (0, utils_1.bytesToHex)((0, sha256_1.sha256)((0, sha256_1.sha256)((0, utils_1.hexToBytes)(await this.getSignedHex()))).reverse());
    };
    ...
    _finalizeOutputs = async () => {
        ...
        for (const output of this._outputs) {
            ...
            this._outputScriptArr.push((await _bigToLitleEndian(await _makeHexN(Math.floor(output.amount * 10 ** 8).toString(16), 16))) +
                (output.address
                    ? await (0, exports.getScriptByAddress)(output.address, true)
    ...
    _sign = async (pubkey, privkey, unsignedTx, inputIdx, isMultiSig, timeLockScript = '', secretHex = '') => {
        ...
        if (secretHex.length !== 0) {
            hashLockScript =
                (await (0, exports.generateHashLockScript)(secretHex)) + Opcode_js_1.default.OP_DROP;
        ...
        if (!isMultiSig) {
            ...
            const p2pkh = await (0, exports.generateSingleSigScript)(pubkey[0]);
