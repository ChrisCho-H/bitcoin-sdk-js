...
exports.Transaction = exports.generateKeyPair = exports.generateScriptAddress = exports.generateMultiSigScript = exports.generateAddress = void 0;
...
class Transaction {
    ...
    _finalizeInputs = async () => {
        ...
        const inputCount = await this._getVarInt(this._inputs.length);
        ...
        for (const input of this._inputs) {
            ...
            */
            const inputScript = await this._bigToLitleEndian(input.id) +
    ...
    _finalizeOutputs = async () => {
        ...
        const outputCount = await this._getVarInt(this._outputs.length);
